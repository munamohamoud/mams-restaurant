...
import 'package:restaurant/SearchNotFound.dart';
import 'package:restaurant/main.dart';
import 'package:restaurant/searchResults.dart'; //userinfo from firebase_auth + logOut
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => SearchPage(title: "Finders")));
          },
        appBar: AppBar(
...
=======
            ...
            TextButton(
>>>>>>> eb4b78db271bb6be32b8041705c6126bfb566e91:App_UI/lib/Profile.dart
                onPressed: () {
